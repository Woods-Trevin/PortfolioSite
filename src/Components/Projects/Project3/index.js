    ...
    return (
        <div className="projectThree_outmost_ctnr">
            ...
            <div className="projectTwo_links_ctnr">
                <a className="projectTwo_live_link" href="https://triple-confirmed-games.herokuapp.com/">Live </a>
                {'|'}
                <a className="projectTwo_repo_link" href="https://github.com/Woods-Trevin/TripleConfirmedGames"> Repo</a>
            </div>
        </div>
    );
};